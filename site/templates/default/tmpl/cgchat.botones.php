...
<div id="CGCHAT_botones">
	...
	<a title="<?php echo Text::_("COM_CGCHAT_HISTORY"); ?>" href="<?php echo Route::_('index.php?option=com_cgchat&view=history&page=1&return='.base64_encode($uri)); ?>"><img alt="<?php echo Text::_("COM_CGCHAT_HISTORY"); ?>" src="<?php echo $this->include_html("botones", "history.png"); ?>" /></a>
