...
<div id="CGCHAT_botones">
	<img alt="<?php echo JText::_("COM_CGCHAT_TURN"); ?>" id="encendido" src="<?php echo $this->include_html("botones", "encendido_0.gif"); ?>" />
	...
	<a title="<?php echo JText::_("COM_CGCHAT_FAQ"); ?>" href="javascript:cgchat.show('CGCHAT_rangos')"><img alt="<?php echo JText::_("COM_CGCHAT_FAQ"); ?>" src="<?php echo $this->include_html("botones", "faq.png"); ?>" /></a>
