...
<div id="KIDE_opciones" class="KIDE_mostrar" style="display: none">
	<div><?php echo JText::_("COM_CGCHAT_OCULTAR_SESION"); ?> <input type="checkbox" value="1" name="ocultar_sesion" id="ocultar_sesion" <?php if ($this->user->ocultar_sesion) echo 'checked="checked" '; ?> style="vertical-align:middle" /></div>
	<div><?php echo JText::_('COM_CGCHAT_TEMPLATE'); ?>: <?php echo $this->templates; ?></div>
	<div id="KIDE_opciones_colores"></div>
	<br />
	<button onclick="kide.save_options()"><?php echo JText::_("COM_CGCHAT_SAVE"); ?></button> <button onclick="kide.retardo_input()"><?php echo JText::_("COM_CGCHAT_RETARDO_INPUT"); ?></button>
</div>
		...
		<tr>
			<td>
				...
				<span id="KIDE_mensaje_perfil_span">
					<br />
					· <a target="_blank" id="KIDE_mensaje_perfil" href="javascript:void(0)"><?php echo JText::_("COM_CGCHAT_VERPERFIL"); ?></a>
				</span>
				<span id="KIDE_mensaje_borrar_span">
					<br />
					· <a id="KIDE_mensaje_borrar" href="javascript:void(0)"><?php echo JText::_("COM_CGCHAT_BORRARMENSAJE"); ?></a>
				</span>
				<span id="KIDE_mensaje_ocultar_span">
					<br />
					· <a id="KIDE_mensaje_ocultar" href="javascript:void(0)"><?php echo JText::_("COM_CGCHAT_HIDE_MESSAGE"); ?></a>
				</span>
				<?php if ($this->user->rango == 1) : ?>
				<span id="KIDE_mensaje_banear_span1">
					<br />
					· <a href="javascript:kide.show('KIDE_mensaje_banear_span')"><?php echo JText::_("COM_CGCHAT_MENSAJE_BANEAR"); ?></a>
					<span id="KIDE_mensaje_banear_span" style="display: none">
						...
						<button style="padding:0" id="KIDE_mensaje_banear"><?php echo JText::_("COM_CGCHAT_MENSAJE_BANEAR_MIN"); ?></button>
					</span>
				</span>
				<?php endif; ?>
				<br />
		...
		<tr>
			<td>
				...
				<span id="KIDE_usuario_banear_span1">
					<br />
					· <a href="javascript:kide.show('KIDE_usuario_banear_span')"><?php echo JText::_("COM_CGCHAT_MENSAJE_BANEAR"); ?></a>
